...
const WA_MESSAGE = "Halo Bintuneo, saya ingin berkonsultasi mengenai detail dan pasokan Buah Merah dan Buah Pala";

const WhatsappKomoditas = () => {
...
export default WhatsappKomoditas;